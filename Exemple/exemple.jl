...
# Fonction sigmoïde
print(SimulationHPV.sigmoid.([12.0,12.0,130]))
...
n = 5
SimulationHPV.estim_Confusion(moda_ageSexe,propo_ageSexe,taux_age_sex,n,propo_age)

# Fonction Estim_Vaccin
df_bool_vaccin = DataFrame(rand(Bool, 100, 12),:auto)
prop_vaccin_simul = 0.55
print(SimulationHPV.estim_Vaccin(df_bool, prop_vaccin_simul))

# Fonction Estim_b0
print(SimulationHPV.estim_b0.([0.05,0.06],[12.9,13]))

# Fonction Estim_HPV
prop = SimulationHPV.borneSomme([16.5,70.9,7.2]/100,[20.7,75.5,9.4]/100)
df_bool_HPV = DataFrame(rand(Bool, 100, 15),:auto)
print(SimulationHPV.estim_HPV(df_bool_HPV,[0.4,0.2],6,0.05))
